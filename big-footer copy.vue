      ...
      <span class="inline-flex gap-8 flex-wrap justify-center">
        <span class="flex flex-col items-center">
          <NuxtLink
            ...
            rel="noopener noreferrer"
            class="partner-logo"
            :style="`background-image: url('${imgPathPrefix}/logo/tme.png')`"
          >
      ...
      <span class="inline-flex gap-8 flex-wrap justify-center">
        <span class="flex flex-col items-center">
          <NuxtLink
            ...
            rel="noopener noreferrer"
            class="partner-logo"
            :style="`background-image: url('${imgPathPrefix}/logo/astar.png')`"
          >
        ...
        <span class="flex flex-col items-center">
          <NuxtLink
            ...
            rel="noopener noreferrer"
            class="partner-logo"
            :style="`background-image: url('${imgPathPrefix}/logo/mab-robotics.png')`"
          >
        ...
        <span class="flex flex-col items-center">
          <NuxtLink
            ...
            rel="noopener noreferrer"
            class="partner-logo"
            :style="`background-image: url('${imgPathPrefix}/logo/manu.png')`"
          >
            <span class="sr-only">Małopolska Akademia Nabywania Umiejętności</span>
          </NuxtLink>

          <span v-if="$props.logoSize !== 'small'" class="font-bold text-xl">
            Małopolska Akademia<br />Nabywania Umiejętności
          </span>
        </span>
      </span>
    </div>
      ...
      <span class="inline-flex gap-8 flex-wrap justify-center">
        <span class="flex flex-col items-center">
          <NuxtLink
            ...
            rel="noopener noreferrer"
            class="partner-logo"
            :style="`background-image: url('${imgPathPrefix}/logo/scanmed.jpg')`"
          >
      ...
      <span class="inline-flex gap-8 flex-wrap justify-center">
        <span class="flex flex-col items-center">
          <NuxtLink
            ...
            rel="noopener noreferrer"
            class="partner-logo"
            :style="`background-image: url('${imgPathPrefix}/logo/krakow-pl.jpg')`"
          >
      ...
      <span class="inline-flex gap-8 flex-wrap justify-center">
        <span class="flex flex-col items-center">
          <NuxtLink
            ...
            rel="noopener noreferrer"
            class="partner-logo"
            :style="`background-image: url('${imgPathPrefix}/logo/miasto-krakow.jpg')`"
          >
      ...
      <span class="inline-flex gap-8 flex-wrap justify-center">
        <span class="flex flex-col items-center">
          <NuxtLink
            ...
            rel="noopener noreferrer"
            class="partner-logo"
            :style="`background-image: url('${imgPathPrefix}/logo/rainlabs.png')`"
          >
        ...
        <span class="flex flex-col items-center">
          <NuxtLink
            ...
            :style="`background-image: url('${imgPathPrefix}/logo/wiet.png')`"
          >
            <span class="sr-only">Wydział Informatyki, Elektroniki i Telekomunikacji</span>
          </NuxtLink>

          <span v-if="$props.logoSize !== 'small'" class="text-lg">Wydział</span>
          <span v-if="$props.logoSize !== 'small'" class="font-bold text-base">
            Informatyki, Elektroniki<br />i Telekomunikacji
          </span>
        </span>
        ...
        <span class="flex flex-col items-center">
          <NuxtLink
            ...
            rel="noopener noreferrer"
            class="partner-logo !p-6"
            :style="`background-image: url('${imgPathPrefix}/logo/uciekamy-cukrzycy.png')`"
          >
